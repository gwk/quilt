...
public class Random {
  ...
  private var state0: U64
  private var state1: U64

  public init(state0: U64 = 0x123456789ABCDEF, state1: U64 = 0x123456789ABCDEF) {
    self.state0 = state0
    self.state1 = state1
  }
  ...
  @warn_unused_result
  public func u64(min: U64, end: U64) -> U64 {
